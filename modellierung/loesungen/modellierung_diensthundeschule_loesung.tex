          ...
          \begin{center}
            \scalebox{.5}{
              \begin{tikzpicture}[node distance=1.5cm, every edge/.style={link}]
                ...
                \node[relationship](durchlaeuft)[below = 2cm of diensthund]{durchl\"auft} edge node[auto,swap]{(1,*)}(diensthund);
                ...
                \node[relationship](fuehrtdurch) at (5,-12){f\"uhrt druch};
                ...
                \node[relationship](unterstuetzt) at (5,-16){unterst\"utzt};
                ...
                \node[relationship](enthaelt)[below = 2cm of behandlungsposition]{enth\"alt} edge node[auto,swap]{(1,1)}(behandlungsposition);
