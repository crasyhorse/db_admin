          ...
          \begin{center}
            \scalebox{.5}{
              \begin{tikzpicture}[node distance=1.25cm, every edge/.style={link}]
                ...
                \node[relationship](rel1)[below = of A]{geh\"ort zu} edge node[auto,swap] {(0,*)}(A);
...
\clearpage
          ...
          \begin{center}
            \scalebox{.5}{
              \begin{tikzpicture}[node distance=1cm, every edge/.style={link}]
                ...
                \node[relationship](rel2)[above = of B]{geh\"ort zu} edge node[auto,swap]{(1,1)} (B);
                ...
                \node[relationship](rel3)[below = of B]{geh\"ort zu} edge node[auto,swap]{(0,*)} (B);
        ...
        \subsubsection{Transformation Zusatzaufgabe 1}
          In dieser Transformation werden nur die \"Anderungen zur urspr\"unglichen Aufgabe gezeigt!
					\begin{tabular}{>{\textbf\bgroup}p{3.1cm}<{\egroup}>{\small}p{12cm}}
  ...
  \clearpage
          ...
          \begin{center}
            \scalebox{.55}{
              \begin{tikzpicture}[node distance=1.7cm, every edge/.style={link}]
                ...
                \node[relationship](rel1)[below right = of A]{geh\"ort zu} edge node[auto,swap] {(1,*)}(A);
      ...
      %             \node[attribute](g1)[above right = of G]{\key{Eintrittskarte\_ID}} edge (G);
                ...
                \node[entity](J)[below left = of K]{Ehemalige};
                  \node[attribute](j1)[below left = of J]{K\"undigungsdatum} edge (J);
          ...
          \end{center}
          Aus Platzgr\"unden wurde bei den beiden Entitit\"aten \enquote{Ehemalige} und \enquote{Bademeister} das Attribut \enquote{Personal\_ID} weggelassen!
        \subsubsection{Transformation Zusatzaufgabe 3}
					\begin{tabular}{>{\textbf\bgroup}p{3.1cm}<{\egroup}>{\small}p{12cm}}
						...
						Ehemalige & (\fk{\pk{Personal\_ID}}, K\"undigungsdatum) \\
					\end{tabular}
\clearpage
