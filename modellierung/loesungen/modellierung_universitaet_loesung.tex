      \subsection{\"Ubungsaufgabe Universit\"at}
        \subsubsection{Vorgaben}
          \begin{center}
            \scalebox{.45}{
              \begin{tikzpicture}[node distance=1.5cm, every edge/.style={link}]
                ...
                \node[entity](uebung)[below = 2.1cm of betreut]{\"Ubung} edge node[auto,swap,xshift=5,yshift=-15] {(1,1)}(betreut);
                  \node[attribute](uebungid)[below left = of uebung]{\key{\"Ubung\_ID}} edge (uebung);
                ...
                \node[relationship](haelt)[below = 2.4cm of professor.230]{h\"alt} edge node[auto,yshift=15,xshift=0] {(1,*)}(professor.230);
                  \path[draw, -] (haelt.south) |- (7,-16) -| (0.4,-16) arc(0:180:0.4cm) -| (vorlesung.east) node[auto,swap,xshift=20,yshift=-10]{(1,1)};
                \node[relationship](fuehrt)[right = of haelt]{f\"uhrt};
                ...
                \node[entity](fakultaet)[below = of umfasst]{Fakult\"at} edge node[auto,swap] {(1,*)}(umfasst);
                  \node[attribute](fakultaetid)[below = of fakultaet]{\key{Fakult\"at\_ID}} edge (fakultaet);
                ...
                \node[entity](rechenuebung) at (-3,-19){Rechen\"ubung};
                  \path[draw, -] (isauebung.west) -| (rechenuebung.north);
                \node[entity](laboruebung) at (3,-19){Labor\"ubung};
                ...
                \node[entity](hoersaal)[below = of findetstattin]{H\"orsaal} edge node[auto,swap] {(0,*)}(findetstattin);
          ...
          \end{center}
          Aus Platzgr\"unden sind nur die Prim\"arschl\"ussel im Modell eingezeichnet.
