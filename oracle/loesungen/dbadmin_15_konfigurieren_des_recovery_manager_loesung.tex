\section{L\"osungen - Konfigurieren des Recovery Manager}
  \begin{enumerate}
    \item Konfigurieren Sie die unten angegebenen Werte f\"ur die beiden Umgebungsvariablen \identifier{nls\_lang} und \identifier{nls\_date\_format}.
      \begin{itemize}
