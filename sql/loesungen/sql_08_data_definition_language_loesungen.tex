\clearpage
    \section{L\"osungen - Erstellen von Views}
      \begin{enumerate}
...
AS
  ...
  FROM   Kunde k INNER JOIN Eigenkunde ek
        ...
        \end{lstlisting}
\clearpage
        \item Erstellen Sie die View \identifier{v\_Finanzberater}, die f\"ur
        alle Eigenkunden deren Vor- und Nachnamen anzeigt, sowie den Vor- und
        den Nachnamen ihres pers\"onlichen Finanzberaters (Tabelle
