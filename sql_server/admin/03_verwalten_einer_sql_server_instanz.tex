      ...
      \subsection{Die Datenbank demo\_grafisch}
        ...
        \begin{center}
          \begin{scriptsize}
            \changefont{pcr}{m}{n}
            \tablefirsthead {
              \multicolumn{1}{>{\centering}p{1.15cm}}{\textbf{Logischer Name}}&
              \multicolumn{1}{c}{\textbf{Dateityp}} &
              \multicolumn{1}{>{\centering}p{1.15cm}}{\textbf{Datei- gruppe}}&
              \multicolumn{1}{>{\centering}p{1.15cm}}{\textbf{Anfangs- größe
              (MB)}} & 
              \multicolumn{1}{>{\centering}p{2cm}}{\textbf{Automatische Vergrößerung}} &
              \multicolumn{1}{c}{\textbf{Pfad}} &
              \multicolumn{1}{c}{\textbf{Dateiname}} \\
              \hline
              }
            \tablehead{}
            \tabletail {
    ...
    \section{Der DBCC - Database Console Commands}
      ...
      \subsection{Überprüfungskommandos}
        ...
        \begin{itemize}
          ...
          \item \languagemssql{CHECKCONSTRAINTS}: Überprüfung die
...
DBCC §SHRINKDATABASE§
    ...
    |)| 
          ...
          \begin{itemize}
            ...
            \languagemssql{TRUNCATEONLY} wirkt sich \languagemssql{?DBCC?
            SHRINKDATABASE} auch auf die Protokolldatei aus.
          ...
          \end{enumerate}
          \begin{merke}
            Werden die beiden Option \languagemssql{TRUNCATEONLY} und
...
?DBCC? SHRINKDATABASE(demo_grafisch, 25)
          \end{lstlisting}          
          Das \languagemssql{SHRINKDATABASE}-Kommando aus \beispiel{admin03_33}
...
an den Systemadministrator.
          \end{lstlisting}          
          Mit dem Befehl aus \beispiel{admin03_36} wird eine Syntax-Hilfe zum
