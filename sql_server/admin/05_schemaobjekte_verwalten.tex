    ...
    \section{Indexentwurf im SQL Server}
      ...
      \subsection{Allgemeine Hilfestellungen für den Indexentwurf}
        ...
        \subsubsection{Indizes in einer OLTP-Datenbank}
          ...
          \languagemssql{WHERE plz = 90411 AND ort = 'Nürnberg'} durch. In
          ...
          \languagemssql{WHERE ort = 'Nürnberg'  AND plz = 90411} durch. Auch
          ...
          \languagemssql{WHERE ort = 'Nürnberg'}. In diesem Fall kann der Index
